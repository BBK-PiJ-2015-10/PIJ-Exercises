...
public class Exer2 {
	...
	public void launch (){
		...
		System.out.println("Now using the static method e-checker");
		Collections.sort(list,(String str1, String str2) -> 
		(StringUtils.eChecker(str1,str2)));
		System.out.println(Arrays.asList(list));
		
		//Collections.sort(list,(Ecomparator.ecompare(String str1, String str2));
		//System.out.println(Array.asList(list));
